...
import com.cshep4.premierpredictor.matchupdate.repository.mongo.LiveMatchRepository.Companion.COLLECTION
import com.cshep4.premierpredictor.matchupdate.repository.mongo.LiveMatchRepository.Companion.DATABASE
...
internal class LiveMatchRepositoryTest {
    ...
    fun `'findById' gets documents with id from database`() {
        ...
        val result = liveMatchRepository.findById(ID_1)
    ...
    fun `'findById' returns null if document does not exist`() {
        ...
        val result = liveMatchRepository.findById(ID_2)
